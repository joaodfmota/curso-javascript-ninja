...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é João Mota!'
...
// Agora, apresente-se ;)
pessoa.apresentacao(); // 'Olá, eu sou o João Mota, tenho 28 anos, 1.8m, meu peso é 87kg e, só hoje, eu já caminhei 180 metros!'
```
